...
q5_image = Image.open('q5Image.jpg')
q6_image = Image.open('q6Image.jpg')
q8_image = Image.open('q8Image.jpg')
q9_image = Image.open('q9Image.jpg')
q10_image = Image.open('q10Image.webp')
q11_image = Image.open('q11Image.jpg')
...
if (success == True) & (responses[9] is None):
    st.divider()
    st.image(q9_image)
    answer = st.text_input('Which of the severn dwarves is last alphabetically?: ')
